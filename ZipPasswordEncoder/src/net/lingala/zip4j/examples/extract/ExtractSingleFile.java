...
public class ExtractSingleFile {
	...
	public ExtractSingleFile() {
		...
		try {
			...
			ZipFile zipFile = new ZipFile("D:\\shahzad_payslip.zip");
			
			// Check to see if the zip file is password protected 
			if (zipFile.isEncrypted()) {
				// if yes, then set the password for the zip file
				zipFile.setPassword("hello");
			}
			
			// Specify the file name which has to be extracted and the path to which
			// this file has to be extracted
			zipFile.extractFile("Pay Slip_Shahzad_Feb16.pdf", "D:\\ZipTest\\");
			...
			zipFile.extractFile("Pay Slip_Shahzad_March16.pdf", "D:\\ZipTest\\");
